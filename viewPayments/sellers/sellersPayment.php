			...
			<div class="banner-top">
				<div class="row">
					<div class="col-md-3 col-sm-4 col-6 mg">
						<h3 class="banner-top-text text-light">SELLER PAYMENT</h3>
					</div>
			...
			<div class="container" style="padding-top: 80px;">
				...
				<div class="print-container">
					<div id = "print-heading">
						<h3 style="text-align:center; font-weight: bold; margin-top:50px">Sellers Payment</h3>
					</div>
					<div class="px-3 mb-3">
					...
					<div class="px-3 table-responsive">
						...
						<table id="myTable" class="table table-striped borderless table-bordered">
							...
							<tbody>
								...
								<?php  
									$sql = "SELECT sid, date, amount, name  FROM seller_payment INNER JOIN sellers ON seller_payment.sid=sellers.phn_no where seller_payment.date between '$sDate' and '$enDate' order by seller_payment.date desc";
