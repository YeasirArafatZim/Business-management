			...
			<div class="banner-top">
				<div class="row">
					<div class="col-md-3 col-sm-4 col-6 mg">
						<h3 class="banner-top-text text-light">Extra Costs</h3>
					</div>
			...
			<div class="container" style="padding-top: 80px;">
				...
				<div class="print-container">
					<div id = "print-heading">
						<h3 style="text-align:center; font-weight: bold; margin-top:50px">Extra Costs</h3>
					</div>
					<div class="px-3 mb-3">
						<h4 style="font-weight:bold; display: inline">Total Costs: </h4>
						<h4 id="tAmount" style="font-weight:bold; color:red; display: inline">0 </h4>
						...
						<table id="myTable" class="table table-striped borderless table-bordered">
							<thead class="table-dark">
								<tr>
									...
									<th class="text-center" scope="col">Cost Name</th>
							...
							<tbody>
								...
								<tr>
									...
									<td class="text-center" style="color: black;"><?php echo $costName  ?></td>
									<td class="text-center" style="font-weight: bold; color: red;"><?php echo round($amount,2)  ?><sub style="color:gray;">ট</sub></td>
									<td class="text-center" style="color: black;"><?php echo $date  ?></td>
									<td class="text-center" style="color: black;"><?php echo $time  ?></td>
									<td class="text-center" > <button data-bs-toggle="modal" data-bs-target="#exampleModal<?php echo $cost_id;?>" style="margin: 0px; padding: 0px; background-color:white; cursor:pointer"><i class="fas fa-trash-alt fa-lg" style="color:red; background-color:white"></i></button> </td>
								</tr>

								<!-- Modal -->
								<div class="modal fade" id="exampleModal<?php echo $cost_id;?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
										<div class="modal-dialog modal-dialog-centered">
											...
											<div class="modal-footer">
												...
												<a href="delete.php?cost_id=<?php echo $cost_id;?>" class="btn" style="background-color:#ff1a1a">Delete</a>
											</div>
											</div>
										</div>
									</div>
