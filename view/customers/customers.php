...
<head>
	...
	<title>মুণি ট্রেডার্স &#8211; Customers </title>
		...
		<div id="doro-main">
			...
			<div class="banner-top">
				<div class="row">
					<div class="col-md-3 col-sm-4 col-6 mg">
						<h3 class="banner-top-text text-light">CUSTOMERS</h3>
					</div>
			...
			<div class="container" style="padding-top: 80px;">
                <div class="px-3 table-responsive">
                    <input type="text" id="myInput" onkeyup="mySearchFunction()" placeholder="Search for customers..">
                    <table id="myTable" class="table table-striped borderless table-bordered">
                        ...
                        <tbody>
                            <?php  
                                $sql = "SELECT * FROM customers order by due";
