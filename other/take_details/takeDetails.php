...
<head>
	...
	<title>মুণি ট্রেডার্স &#8211; Money Received </title>
			...
			<div class="banner-top">
				<div class="row">
					<div class="col-md-3 col-sm-4 col-6 mg">
						<h3 class="banner-top-text text-light">Taken</h3>
					</div>
					...
					<div class="px-3 table-responsive">
						<table id="myTable" class="table table-striped borderless table-bordered">
							...
							<tbody>
								...
								<?php  
									$sql = "SELECT mishuk_give.id as id, mishuk_give.phn_no as phn_no, mishuk_give.date as date, mishuk_give.amount as amount, mishuk.name as name FROM mishuk_give inner join mishuk on mishuk.phn_no=mishuk_give.phn_no where mishuk_give.date between '$sDate' and '$enDate' order by mishuk_give.date desc";
