...
<head>
	...
	<title>মুণি ট্রেডার্স &#8211; Take </title>
		...
		<div id="doro-main">
			...
			<div class="banner-top">
				<div class="row">
					<div class="col-md-3 col-sm-4 col-6 mg">
						<h3 class="banner-top-text text-light">Money Received</h3>
					</div>
			...
			<div class="container" style="padding-top: 80px">
                ...
                <div style="text-align:center; font-weight:bold">
                    <h3 style="font-weight:bold">Recieved Money from Cash</h3>
                </div>
                    ...
                    <div class="box mt-3 mx-auto" style="width:70%;">
						...
						<div class="row mt-3 mx-2">
                            <div class="col-md-12 position-static">
								<label for="c_phn">Amount</label><br>
                            	<input type="number" min="0" step="0.1" placeholder="amount" id="amount" name="amount" required><br>
                            </div>
                        </div>
