...
<head>
	...
	<title>মুণি ট্রেডার্স &#8211; Other </title>
			...
			<div class="banner-top">
				<div class="row">
					<div class="col-md-3 col-sm-4 col-6 mg">
						<h3 class="banner-top-text text-light">Status</h3>
					</div>
                    ...
                    <table id="myTable" class="table table-striped borderless table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td style="font-weight: bold; color: red; text-align:center"><?php echo round($amount,2);  ?><sub style="color:gray;">ট</sub></td>
                            </tr>
