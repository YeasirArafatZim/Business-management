...
<head>
	...
	<title>মুণি ট্রেডার্স &#8211;Money Recieved </title>
	...
	<div id="doro-page"> <a href="#" class="js-doro-nav-toggle doro-nav-toggle"><i></i></a>
		...
		<div id="doro-main">
			...
			<div class="banner-top">
				<div class="row">
					<div class="col-md-3 col-sm-4 col-6 mg">
						<h3 class="banner-top-text text-light">Recieved Cash</h3>
					</div>
			...
			<div class="container px-5 boxWidth">
                ...
                <div class="box mt-3 px-5 pt-4">
                    
					<div class="row">
                        <div class="col-md-6 col-sm-6 col-6 position-static">
                            <p class="verify_label">Total Amount: </p>
                        </div>
                        <div class="col-md-6 col-sm-6 col-6 position-static">
