                    ...
                    <div class="box mt-3">
                        <div class="row mt-4 mx-1">
                            <div class="col-md-12 position-static">
                                <label>Seller Mobile Number:</label><br>
                        ...
                        <div class="row mt-3 mx-2">
                            <div class="col-md-12 position-static">
                                ...
                                <input type="text" placeholder="seller name*" id="s_name" name="s_name" required>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3 mx-2">
							<div class="col-md-12 position-static">
                            	...
                            	<input type="text" placeholder="seller address*" id="address" name="address" required><br>
                            </div>
						</div>
