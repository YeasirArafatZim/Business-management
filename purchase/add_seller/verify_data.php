...
<head>
	...
	<link rel="stylesheet" type="text/css" href="../purchase_style.css" media='all'>
		...
		<div id="doro-main">
			...
			<div class="container px-5 boxWidth">
                ...
                <div class="box mt-3 px-5 py-3">
                    ...
                    <div class="row">
                        <div class="col-md-6 col-sm-6 col-6 position-static">
                            <p class="verify_label">Seller Mobile No: </p>
                        </div>
                        <div class="col-md-6 col-sm-6 col-6 position-static">
					...
					<div class="row">
                        <div class="col-md-6 col-sm-6 col-6 position-static">
                            <p class="verify_label">Seller Name: </p>
                        </div>
                        <div class="col-md-6 col-sm-6 col-6 position-static">
					...
					<div class="row">
                        <div class="col-md-6 col-sm-6 col-6 position-static">
                            <p class="verify_label">Seller Address: </p>
                        </div>
                        <div class="col-md-6 col-sm-6 col-6 position-static">
