                    ...
                    <div class="box mt-3">
                        <div class="row mt-4 mx-1">
                            ...
                            <div class="col-md-6 position-static">
                                ...
                                <input type="text" placeholder="price /kg" id="price" name="pprice" required><br>
                            </div>
                        </div>
                        ...
                        <div class="row mt-3 mx-2">
							<div class="col-md-6 position-static">
								<label for="s_phn">Seller Mobile No</label><br>
                            ...
                            <div class="col-md-6 position-static">
                                ...
                                <input type="number" min="0" placeholder="amount paid to the seller" id="paid_amount" name="paid_amount" required><br>
                            </div>
						</div>
