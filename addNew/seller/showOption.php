...
$sql="SELECT * from sellers where phn_no = '$phn'";
...
?>
    <div class="row mt-3 mx-2">
        <div class="col-md-12 position-static">
            ...
            <input type="text" placeholder="Seller's name*" id="c_name" name="c_name" required>
        </div>
    </div>
...
<div class="row mt-3 mx-2">
        <div class="col-md-12 position-static text-center">
            <label for="s_phn" style="color:red;">This Seller is already added</label><br>
